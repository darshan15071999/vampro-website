...
export default function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }: any) {
  ...
  return (
    <div
      ref={containerRef}
      className={`h-[360px] w-full relative overflow-hidden grid place-items-center aspect-[4/5] border border-transparent rounded-[2rem] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
