      ...
      <div className="w-full px-6 md:px-10 lg:px-16 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            {[['About Us', () => navigate('/', 'about')], ['Services', () => navigate('/', 'services')], ['Software', () => navigate('/software/signalscope')], ['Documentation', () => navigate('/docs/software/signalscope')]].map(([label, fn]) => (
...
export default SignalScopeFooter;
