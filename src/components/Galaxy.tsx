...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    // Cache bounding rect to avoid layout reflow on every mousemove
    ...
    // Also update cached rect on resize
    ...
    window.addEventListener('resize', resizeAndCache, false);

    return () => {
      cancelAnimationFrame(animateId);
      window.removeEventListener('resize', resizeAndCache);
