      ...
      <div className="w-full px-6 md:px-10 lg:px-16 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            {[['About Us', () => navigate('/', 'about')], ['Services', () => navigate('/', 'services')], ['Games', () => navigate('/games/spoch')], ['Documentation', () => navigate('/docs/games/spoch')]].map(([label, fn]) => (
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li><a href="https://instagram.com/vampro.tech" target="_blank" rel="noreferrer" className="hover:text-indigo-400 transition-colors">Instagram</a></li>
