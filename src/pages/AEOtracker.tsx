...
const HeroSearchAnimation = () => {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center opacity-50">
      ...
      />
      <svg className="absolute w-full h-full opacity-70" viewBox="0 0 1000 200" preserveAspectRatio="none">
        <motion.path
    ...
    <div className="animate-in fade-in duration-500 bg-slate-950 min-h-screen text-white selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <div className="bg-gradient-to-r from-[#3B3BFF] via-[#1B2A6B] to-[#3B3BFF] text-white py-1.5 px-4 flex items-center justify-center gap-3 sticky top-[96px] z-40 shadow-md border-b border-indigo-500/20">
        <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-90 flex items-center gap-2">
          <Bot size={12} /> SignalScope by Vampro - Launching in phases. Starting with Reddit Intelligence.
        </span>
        {hasJoined ? (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeInSection>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1]">
                <span className="text-white">The Future of Search Is </span><br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-blue-400 to-sky-400">
                  <TypingText text="Being Written Right Now." delay={0.5} />
                </span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-400 mb-6 leading-relaxed font-light">
                Every day, millions of conversations shape what AI systems will eventually recommend. Most brands never see them.
              </p>
              <p className="text-lg text-slate-500 mb-10 leading-relaxed max-w-xl">
                SignalScope helps you discover the discussions influencing tomorrow's AI answers. Built by Vampro. Launching in phases. Starting with Reddit Intelligence.
              </p>
            ...
            <FadeInSection delay="200ms" className="relative flex items-center justify-center lg:justify-end w-full">
      ...
      <section className="py-24 md:py-32 border-b border-slate-800/50 dark-dot-bg relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeInSection className="text-center max-w-4xl mx-auto mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold text-white mb-8">Search Is Becoming Recommendation.</h2>
            <p className="text-xl md:text-2xl text-slate-400 font-light leading-relaxed mb-6">
              For twenty years, discoverability meant rankings. Today, it means something else.
            </p>
          </FadeInSection>
          ...
          <FadeInSection delay="400ms" className="mt-16 text-center">
            <div className="glass-card p-6 inline-block rounded-2xl border-[#3B3BFF]/30 shadow-[0_0_30px_rgba(59,59,255,0.15)]">
              <p className="text-xl md:text-2xl text-[#3B3BFF] font-medium flex items-center gap-3">
                <Activity size={24} /> The next generation of visibility starts before the recommendation.
              </p>
            </div>
          </FadeInSection>
        </div>
      ...
      <section className="py-24 md:py-32 relative z-10 dark-grid-bg">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeInSection className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">We're Building The Visibility Layer For AI Search.</h2>
            <p className="text-xl text-slate-400 font-light">Imagine knowing:</p>
          </FadeInSection>
          ...
          <FadeInSection delay="400ms" className="text-center">
            ...
            <p className="text-xl text-[#3B3BFF]">A unified intelligence layer for the age of AI search.</p>
          </FadeInSection>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 relative z-10 dark-grid-bg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInSection className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">But Every Platform Starts Somewhere.</h2>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">The journey from a casual conversation to a definitive AI recommendation happens in stages.</p>
          </FadeInSection>
          ...
          <FadeInSection delay="500ms">
            <TiltCard>
              <div className="bg-gradient-to-r from-orange-500/10 via-red-500/10 to-orange-500/10 border border-orange-500/30 p-10 md:p-12 rounded-[3rem] shadow-[0_0_50px_rgba(249,115,22,0.15)] glass-card relative overflow-hidden text-center cursor-default">
                ...
                <p className="text-3xl md:text-4xl text-white font-extrabold mb-6">That's why we're starting with Reddit.</p>
                <p className="text-slate-300 text-xl md:text-2xl mb-8 leading-relaxed max-w-4xl mx-auto">Because Reddit has become one of the strongest public datasets influencing modern AI recommendations.</p>
                <div className="inline-flex items-center justify-center bg-orange-500/20 px-6 py-3 rounded-xl border border-orange-500/30">
                  <p className="text-orange-400 font-bold text-sm md:text-base tracking-widest uppercase flex items-center gap-2"><Globe size={18} /> Not the final destination. The first layer.</p>
                </div>
              </div>
            </TiltCard>
          </FadeInSection>
            ...
            <FadeInSection>
              ...
              <div className="glass-card bg-slate-900/50 p-8 rounded-3xl border border-slate-700/50 mb-10 shadow-xl hover:border-orange-500/30 transition-colors">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
                  {['Brand mentions', 'Competitor mentions', 'Community sentiment', 'Recommendation threads', 'Emerging narratives', 'Category momentum'].map((item, i) => (
          ...
          <FadeInSection delay="500ms" className="mt-16 text-center">
            {hasJoined ? (
               ...
               <button onClick={(e) => handleWaitlist(e, 'SignalScope Coming Soon')} className="bg-[#3B3BFF] hover:bg-indigo-500 text-white px-10 py-4 rounded-full font-bold text-lg transition-all shadow-[0_0_30px_rgba(59,59,255,0.4)] hover:-translate-y-1 mx-auto flex items-center gap-2">
                 Join early and get access first <ArrowRight size={18} />
               </button>
            )}
          </FadeInSection>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <FadeInSection>
            ...
            <div className="mt-12 glass-card inline-block px-8 py-4 rounded-full border-indigo-500/20 bg-slate-900/50">
              <p className="text-[#3B3BFF] text-sm md:text-lg uppercase tracking-widest font-bold">
      ...
      <section className="py-32 relative z-10 overflow-hidden text-center dark-grid-bg">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeInSection>
            ...
            <h2 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-blue-400 to-[#3B3BFF] mb-10 leading-tight drop-shadow-md">
            ...
            <p className="text-2xl text-slate-300 font-light mb-12 leading-relaxed max-w-3xl mx-auto bg-slate-900/40 p-6 rounded-3xl border border-slate-700/50 backdrop-blur-md">
              SignalScope helps you understand both. Start exploring Reddit Intelligence today. Join the waitlist for everything that's coming next.
            </p>
