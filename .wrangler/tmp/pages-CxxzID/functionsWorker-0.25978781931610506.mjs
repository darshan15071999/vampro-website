...
var init_chat = __esm({
  "api/chat.ts"() {
    init_functionsRoutes_0_6771645135014082();
...
var import_standardwebhooks, version, ApiKeys, AutomationRuns, Automations, Batch, Broadcasts, ContactProperties, ContactSegments, ContactTopics, Contacts, Domains, Attachments$1, Attachments, Receiving, Emails, Events, Logs, Segments, ChainableTemplateResult, Templates, Topics, Webhooks, defaultBaseUrl, defaultUserAgent, Resend;
var init_dist = __esm({
  "../node_modules/resend/dist/index.mjs"() {
    init_functionsRoutes_0_6771645135014082();
    init_postal_mime();
...
// ../.wrangler/tmp/pages-CxxzID/functionsRoutes-0.6771645135014082.mjs
var routes;
var init_functionsRoutes_0_6771645135014082 = __esm({
  "../.wrangler/tmp/pages-CxxzID/functionsRoutes-0.6771645135014082.mjs"() {
    init_chat();
    init_chat();
    init_lead();
...
// ../.wrangler/tmp/bundle-XHND4P/middleware-loader.entry.ts
init_functionsRoutes_0_6771645135014082();

// ../.wrangler/tmp/bundle-XHND4P/middleware-insertion-facade.js
init_functionsRoutes_0_6771645135014082();
...
//# sourceMappingURL=functionsWorker-0.25978781931610506.mjs.map
